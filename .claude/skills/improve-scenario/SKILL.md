...
- [ ] Resolve scenario file via glob; stop if not found
- [ ] Glob all reports and improvement files for this scenario
...
| Error | Action |
|-------|--------|
| No run history (zero reports) | Tell user to run the scenario first via `run-scenarios-batch <N>`; stop |

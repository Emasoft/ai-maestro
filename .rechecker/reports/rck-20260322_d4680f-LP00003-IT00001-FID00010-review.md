...
- **Timestamp**: 2026-03-22T20:57:34.190Z
- **Input file**: `/Users/emanuelesabetta/ai-maestro/.claude/worktrees/rck-d4680f/components/plugin-builder/RepoScanner.tsx`
...
Context: Next.js 14 App Router TypeScript project (AI Maestro dashboard). RepoScanner.tsx lets users enter a GitHub repo URL, scans it for available skills/scripts via the scan-repo API, and lets them add those skills to the plugin being composed.

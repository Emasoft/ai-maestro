...
- **Timestamp**: 2026-03-22T21:01:54.105Z
- **Input file**: `/Users/emanuelesabetta/ai-maestro/.claude/worktrees/rck-d4680f/components/plugin-builder/SkillPicker.tsx`
...
Context: Next.js 14 App Router TypeScript project (AI Maestro dashboard). SkillPicker component lets users pick skills from local/marketplace sources. Marketplace skills use compound keys (marketplace+id). Recently fixed: null-safe filter predicates, compound React keys, consistent getSkillKey format, guarded name/description/aria-label renders.

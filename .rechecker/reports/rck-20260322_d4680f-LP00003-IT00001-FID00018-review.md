...
- **Timestamp**: 2026-03-22T20:57:42.169Z
- **Input file**: `/Users/emanuelesabetta/ai-maestro/.claude/worktrees/rck-d4680f/services/headless-router.ts`
...
Context: Next.js 14 App Router TypeScript project (AI Maestro dashboard). headless-router.ts is a standalone HTTP router for headless (no-UI) mode. Added new plugin-builder API routes in this PR (build, builds/[id], push, scan-repo endpoints).

...
- **Timestamp**: 2026-03-22T20:57:50.779Z
- **Input file**: `/Users/emanuelesabetta/ai-maestro/.claude/worktrees/rck-d4680f/types/plugin-builder.ts`
...
Context: Next.js 14 App Router TypeScript project (AI Maestro dashboard). types/plugin-builder.ts defines TypeScript types for the plugin builder feature: BuildConfig, SkillSelection types, build status types, etc.

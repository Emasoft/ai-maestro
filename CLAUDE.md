...
node scripts/wikimem-index.mjs --write .claude/project/memory/ai-maestro-overview.md
```

The wikimem index at the bottom of this file is written by the **ai-maestro-janitor** plugin, on
its own hook — not by that script, which now refuses `CLAUDE.md` as a write target (TRDD-LS9N71DX).
Two indexes over one corpus doubled the fixed cost of the file that rides every turn's cached
prefix, and the hand-run one was the stale half. Editing between the fences is pointless; the next
...
- [haephestos-creation-helper](.claude/project/memory/haephestos-creation-helper.md) — haephestos creation-helper remembers a previous session
...
- [janitor-chore-absorbability-github-audit-and-autoupdate-monitoring](.claude/project/memory/janitor-chore-absorbability-github-audit-and-autoupdate-monitoring.md) — which repos does the github-config-audit scan
- [janitor-chore-absorbability-hibernation-and-guard-gaps](.claude/project/memory/janitor-chore-absorbability-hibernation-and-guard-gaps.md) — is a hibernated agent broken
- [janitor-chore-absorbability-ownership-and-liveness-signals](.claude/project/memory/janitor-chore-absorbability-ownership-and-liveness-signals.md) — a chore runs on both sides
- [janitor-chore-absorbability-test-and-handover](.claude/project/memory/janitor-chore-absorbability-test-and-handover.md) — can the ai-maestro server take over this janitor chore

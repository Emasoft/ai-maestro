...
[![Version](https://img.shields.io/badge/version-0.28.0-blue)](https://github.com/Emasoft/ai-maestro/releases)
...
- Code-analysis tooling (tldr-code, fastedit, distill) for agent-driven code reading and editing

...
updated: 2026-09-05T17:37:22+0200
...
- 2026-09-05T17:37:22+0200 — CORRECTION to the previous line: the dispatch ledger DOES exist, at .janitor/state/tickets/dispatch-ledger.jsonl (one directory deeper than the path first searched), and carries 3 entries for T-A1EHL7K6 — the janitor's three-dispatch statement is now first-hand; dispatched_at 1784668568 = 2026-07-21T21:16Z (the previous line's conversion printed blank: bash resolves GNU date here, whose -r takes a file, so -d @epoch is the form). Still second-hand: the detector fix 49baa78c / janitor issue 130.

...
- 2026-09-05T11:41:34+0200 — box 3 evidence, stated precisely: the accept branch was proven on a temp-dir fixture through the PATH binary, not on a live card, because no blocked card on the board has every blocker terminal today — a live blocked→complete would have REFUSED (correctly, per the new block), so the fixture was the only route to the accept branch; the live corpus validate at its 5-WARN floor with no GRAPH-DANGLING-BLOCKER is the corpus-side half.

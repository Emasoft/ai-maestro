...
- 2026-07-07T13:24:46+0200 — REFUSED by USER-delegated batch screening (tier 2). Mocked-CLI unit tests conflict with the project no-mock testing doctrine; SCEN-025 with real GitHub fixtures (TC8TBJEU/QB5PWIG3/EX7I8WPH chain) is the real-test coverage path.

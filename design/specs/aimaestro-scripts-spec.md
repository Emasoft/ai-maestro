...
| Task signals | amp-task-done · amp-task-blocked · amp-submit-pr | skills/agent-repo-workflow/SKILL.md (owns the three verbs; each --help pairs with its amp-kanban-move half) |
| Messaging status probe | amp-status | commands/amp-status.md |

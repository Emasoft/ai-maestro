...
updated: 2026-08-06T00:36:18+0200
...
- [ ] Surface census done (counts per file class, wire-format impact named).
- [ ] Target shape decided and recorded here with the USER's confirmation if (a).
- [ ] Implemented per the decision; migration + tests if (a), normative note if (b).
- [ ] The terminology memory page and governance spec updated to the decided shape.

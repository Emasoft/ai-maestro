...
| R10.6 | ENFORCED | app/api/sessions/[id]/restart/route.ts:73-91, services/headless-router.ts:1024-1036, services/headless-router.ts:952-962 | tests/governance/r10-restart-manager-gate-parity.test.ts |
| R10.7 | UNENFORCED | — | — |
| R11.1 | CONTRADICTED | — | — |
...
| R34.1 | UNENFORCED | — | — |
| R34.2 | ENFORCED | app/api/agents/foreign-approvals/[id]/approve/route.ts:35-38 | tests/governance/r34-r35-foreign-approval.test.ts |
| R35.1 | UNENFORCED | — | — |
| R35.2 | ENFORCED | app/api/agents/foreign-approvals/[id]/approve/route.ts:35-38 | tests/governance/r34-r35-foreign-approval.test.ts |
| R36.1 | UNENFORCED | — | — |
| R36.2 | UNENFORCED | — | — |
| R37.1 | BEHAVIOURAL | — | — |
...
| R42.8 | ENFORCED | `lib/authorization.ts`, `services/agents-core-service.ts` | `tests/governance/r42-8-unblock-prompt-authority.test.ts`, `tests/services/agents-core-service.test.ts` |
| R42.9 | ENFORCED | `lib/agent-invariants.ts` | `tests/unit/agent-invariants.test.ts` |

...
| R39.7 | A user's ASSISTANT is **invisible to the other agents (except the MAESTRO agent — the MANAGER**, the sole agent that may reach it — R39.9), but it **inherits all tasks and permissions sent to the user** — the user's kanban tasks and granted permissions flow through to their ASSISTANT | Explicit (USER, 2026-07-22 refined — MANAGER carve-out) |

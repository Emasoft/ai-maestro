...
`marketplace-refresh` row removed 2026-09-17 — duty retired: its argless `claude plugin
marketplace update` walked all ~260 registered marketplaces every tick and generated the file
churn that grew fseventsd to 27 GB.

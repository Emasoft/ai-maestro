yarn run v1.22.22
(node:68232) [DEP0169] DeprecationWarning: `url.parse()` behavior is not standardized and prone to errors that have security implications. Use the WHATWG URL API instead. CVEs are not issued for `url.parse()` vulnerabilities.
...
./services/plugin-builder-service.ts:822:30
Type error: Cannot find name 'ExecError'.

[0m [90m 820 |[39m     [90m// Include stderr from execPromise-thrown ExecError for actionable git failure messages[39m[0m
[0m [90m 821 |[39m     [36mlet[39m message [33m=[39m error [36minstanceof[39m [33mError[39m [33m?[39m error[33m.[39mmessage [33m:[39m [33mString[39m(error)[0m
[0m[31m[1m>[22m[39m[90m 822 |[39m     [36mconst[39m execErr [33m=[39m error [36mas[39m [33mExecError[39m[0m
[0m [90m     |[39m                              [31m[1m^[22m[39m[0m
[0m [90m 823 |[39m     [36mif[39m (execErr[33m.[39mstderr) message [33m+=[39m [32m`\nStderr: ${execErr.stderr}`[39m[0m
[0m [90m 824 |[39m     console[33m.[39merror([32m'Error pushing to GitHub:'[39m[33m,[39m error)[0m
[0m [90m 825 |[39m     [36mreturn[39m { error[33m:[39m [32m`Failed to push to GitHub: ${fullMessage}`[39m[33m,[39m status[33m:[39m [35m500[39m }[0m

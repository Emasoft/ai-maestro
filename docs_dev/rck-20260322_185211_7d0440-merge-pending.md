...
- **Worktree**: `rck-7d0440`
- **Branch with fixes**: `worktree-rck-7d0440`
...
```bash
cd "/Users/emanuelesabetta/ai-maestro" && git merge worktree-rck-7d0440 --no-edit
```
...
```bash
rm rck-20260322_185211_7d0440-merge-pending.md && git branch -d worktree-rck-7d0440
```

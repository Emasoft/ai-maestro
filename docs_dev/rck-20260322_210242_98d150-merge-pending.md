...
- **Worktree**: `rck-98d150`
- **Branch with fixes**: `worktree-rck-98d150`
...
```bash
cd "/Users/emanuelesabetta/ai-maestro" && git merge worktree-rck-98d150 --no-edit
```
...
```bash
rm rck-20260322_210242_98d150-merge-pending.md && git branch -d worktree-rck-98d150
```

 ...
 * the Claude CLI never reads (BUG-POLLUTION-001). R17.17's rule text used to say
 * settings.local.json and was wrong; it was CORRECTED (TRDD-RAMCTTHD) and now
 * names settings.json with the reason inline, so rule and guard agree. Do not
 * "fix" this back to match a remembered version of the rule.
 *

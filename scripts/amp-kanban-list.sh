...
show_help() {
    ...
    echo ""
    echo "Options:"
    echo "  --status, -s STATUS        Filter by status — one of the 19 TRDD-v2 pipeline stages:"
...
# server (curl exit 7) killed it HERE and the "❌ Failed to list tasks" branch below never

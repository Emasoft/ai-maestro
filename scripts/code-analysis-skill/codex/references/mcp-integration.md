...
TLDR includes a Model Context Protocol (MCP) server for integration with GPT Code and other MCP-compatible clients.
...
Add to your GPT Code MCP configuration:

...
TLDR includes a Model Context Protocol (MCP) server for integration with Gemini Code and other MCP-compatible clients.
...
Add to your Gemini Code MCP configuration:

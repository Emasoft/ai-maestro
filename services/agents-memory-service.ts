 ...
 *
 * Metrics (getMetrics / updateMetrics) were extracted to
 * services/agents-metrics-service.ts during TRDD-70a521d9 Phase 0 —
 * they have no coupling to this subsystem and must survive its removal.
 */
...
import { getAgent as getRegistryAgent, getAgentBySession, getAgent as getAgentFromFileRegistry } from '@/lib/agent-registry'
...
// getMetrics / updateMetrics were extracted to services/agents-metrics-service.ts
// during TRDD-70a521d9 Phase 0 — they have no coupling to the RAG memory
// subsystem and must survive its removal.

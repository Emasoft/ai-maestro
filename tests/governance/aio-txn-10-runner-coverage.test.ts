 ...
 */
// RefreshAllMarketplaces entry removed 2026-09-17: the pipeline it pinned (the argless CLI
// catalog refresh, marketplace-refresh) no longer exists — the duty was retired (its argless
// `claude plugin marketplace update` walked all ~260 registered marketplaces every tick and
// generated the file churn that grew fseventsd to 27 GB).
